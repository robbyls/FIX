...
public class FIXQuoteRequest {
	...
	public FIXQuoteRequest(String sender, String target, String strSymbol, String quoteReqId, String tenure) {
		super();
		this.sender = sender;
		this.target = target;
	...
	public FIXSessionObject getFixSessionObj() {
		return fixSessionObj;
	}

	public void setFixSessionObj(FIXSessionObject fixSessionObj) {
		this.fixSessionObj = fixSessionObj;
	}
